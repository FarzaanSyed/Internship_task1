...
public class Task3CRUD {
    public static void main(String[] args) {
        ...
        try {
            ...
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Farzaan Syed', 'Computer Science')");
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Maaz Shaikh', 'Business Administration')");
            stmt.executeUpdate("INSERT INTO faculty (faculty_name, dept_name) VALUES ('Zaid Shaikh, 'Computer Applications')");
