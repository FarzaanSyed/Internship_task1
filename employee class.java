...
public class Employee {
    ...
    public static void main(String[] args){
        ...
        Employee employee1 = new Employee(1,"Farzaan Syed", "Data Science",
                "Data Scientist", 100000);

        employee1.work();

        employee1.updateSalary(200000);

        employee1.displayInfo();
            employee1.updateEmployee(3, "Maaz Shaikh", "Data Science","Data Analyst", 200000);
    }
}